                    ...
                    <form action="{{ route('register') }}" method="post">
                        ...
                        <div class="relative w-full mt-10 space-y-8">
                            <div class="relative">
                                ...
                                <input name="name" type="text" class="block w-full px-4 py-4 mt-2 text-xl placeholder-gray-400 bg-gray-200 rounded-lg focus:outline-none focus:ring-4 focus:ring-blue-600 focus:ring-opacity-50" placeholder="Enter Your Name">
                                @error('name')
